...
public class Program
{
    ...
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            double[] l1_endpt1 = { 0.00, 0.00, 0.00 };
            double[] l1_endpt2 = { 10, 20.5, 0.00 };
            double[] l2_endpt1 = { 10, 20.5, 0.00 };
            double[] l2_endpt2 = {  10, 0.00, 2.5 };
            double[] l3_endpt1 = {  10, 0.00, 2.5 };
            double[] l3_endpt2 = {  300 , 2.5, 0.00 };
            double[] l4_endpt1 = {  300, 2.5, 0.00 };
            double[] l4_endpt2 = {  300, 0.00, 0.00 };
            double[] l5_endpt1 = {  300, 0.00, 0.00 };
            double[] l5_endpt2 = { 0.00, 0.00, 0.00 };
        ...
        {
            // ---- Enter your exception handling code here -----
            UI.GetUI().NXMessageBox.Show("Message", NXMessageBox.DialogType.Information, "Деталь с именем model3 уже существует ");
